public class SimpleQueue
{
    public static void Run()
    {
        ...
        // Defect(s) Found: Was trying to access index 1 instead of index 0
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: Enqueue was inserting at front instead of back
        ...
        // Defect(s) Found: None - this test case worked correctly
    }
