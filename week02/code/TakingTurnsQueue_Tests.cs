...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: People with 0 or negative turns (infinite) were not being re-added to queue
    ...
    // Defect(s) Found: Same as above - infinite turns logic was broken
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Tim with 0 turns (infinite) was not being re-added to queue
    ...
    // Defect(s) Found: Tim with negative turns (infinite) was not being re-added to queue
